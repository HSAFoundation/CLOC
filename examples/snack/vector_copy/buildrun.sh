...
echo "g++ -o VectorCopy vector_copy.o VectorCopy.cpp -L/opt/rocm/hsa/lib -lhsa-runtime64"
g++ -o VectorCopy vector_copy.o VectorCopy.cpp -L/opt/rocm/hsa/lib -lhsa-runtime64 
#  Execute
echo ./VectorCopy
./VectorCopy

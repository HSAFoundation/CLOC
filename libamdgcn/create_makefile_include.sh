...
echo "	\$(Verb) \$(LLVM_CC) \$(CLFLAGS) -mcpu=$MCPU -I\$(LIBAMDGCN)/include -I\$(LIBCLC)/generic/lib -MMD -MF \$(DEPSDIR)/convert.cl.d -o \$(BCDIR)/convert.$MCPU.bc \$(UTILDIR)/convert.cl " >>$incfile
